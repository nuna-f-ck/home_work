...
def test_filter_by_state(data_for_state_date):
    assert filter_by_state(data_for_state_date) == [
        {'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
        {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'}]


def test_filter_by_date(data_for_state_date):
    assert sort_by_date(data_for_state_date) == [
