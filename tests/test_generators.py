...
@pytest.mark.parametrize('currency, answer',
                         [("USD",
                           [{'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572',
                            ...
                            {'id': 142264268, 'state': 'EXECUTED', 'date': '2019-04-04T23:20:05.206878',
                             ...
                             'to': 'Счет 75651667383060284188'}]),
                          ("RUB", [{'id': 873106923, 'state': 'EXECUTED', 'date': '2019-03-23T01:09:46.296404',
                                   ...
                                   {'id': 594226727, 'state': 'CANCELED', 'date': '2018-09-12T21:27:25.241689',
                                    ...
                                    'to': 'Счет 14211924144426031657'}])])
def test_filter_by_currency(transactions, error_filter_by_currency, currency, answer):
    filter_by_cur = filter_by_currency(transactions, currency)
    output = []
    for _ in range(2):
        output.append(next(filter_by_cur))
    assert output == answer
    assert next(filter_by_currency(transactions, "kjf")) == error_filter_by_currency
...
def test_card_number_generator():
    ...
    for card_number in card_number_generator(9999999999999995, 9999999999999999):
        output.append(card_number)
    assert output == ['9999 9999 9999 9995', '9999 9999 9999 9996', '9999 9999 9999 9997', '9999 9999 9999 9998',
                      '9999 9999 9999 9999']
